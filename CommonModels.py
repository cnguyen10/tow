...
class CNN(torch.nn.Module):
    ...
    """
    def __init__(self, dim_output: typing.Optional[int] = None, bn_affine: bool = False, stride_flag: bool = True, **kwargs) -> None:
...
class ResNet10(torch.nn.Module):
    ...
    def modified_resnet10(self) -> torch.nn.Module:
        ...
        net = _resnet(arch="resnet10", block=BasicBlock, layers=[1, 1, 1, 1], pretrained=False, progress=False)
